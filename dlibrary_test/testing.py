...
#
#     @property
#     def last_alert_inform(self):
#         return self.__last_alert_inform
#
#     @last_alert_inform.setter
#     def last_alert_inform(self, value):
#         self.__last_alert_inform = value
#
#
...
#
#     @staticmethod
#     def alert_inform(text: str, advice: str, minor_alert: bool):
#         VectorworksInstance().last_alert_inform = {'text': text, 'advice': advice, 'minor_alert': minor_alert}
#
#     @staticmethod
...
#         vs.AlertInform = VectorScript.alert_inform
